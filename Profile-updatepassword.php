                ...
                <div class="row vertical-gap">
                    ...
                    <div class="col-lg-9">
                        ...
                        <div class="nk-social-container">
                            ...
                            <form action="#" method="post">
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="email"  class="form-control" name="email" value="<?php echo $customer_email; ?>" readonly/>
                                        </td>
                                    </tr>
                                ...
                                <div class="nk-gap-2"></div>
                                <button class="nk-btn link-effect-4 float-right" name="Ubutton">Update Password</button>
                            </form>
                            ...
                            $select_query = "SELECT * FROM usermaster WHERE Email = '$Emailid' AND Password = '$OldPassword' ";
                            $result = mysqli_query($conn, $select_query);
                            ...
                            if (isset($_POST['Ubutton'])) {
                                if (isValidPassword($NewPassword)) {
                                    if ($NewPassword !== $ConfirmNewPassword) {
                                        echo "<script> alert('Error: New Password and Confirmation Did not Matched.')</script>";
                                    } else {

                                        if ($row_count > 0) {
                                            $updateQuery = "UPDATE usermaster SET Password = '$NewPassword' WHERE Email = '$Emailid'";
                                    ...
                                    echo "<script> alert('Incorrect Password Pattern.')</script>";
                                }
                            }
                            ?>
                        </div>
