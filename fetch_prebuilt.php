...
if (isset($_POST["action"])) {
    $query = "
        SELECT pre_built_pcs.*, brand.BrandName AS brand_name 
        FROM pre_built_pcs 
        INNER JOIN brand ON pre_built_pcs.BrandID = brand.BrandID 
        WHERE pre_built_pcs.CategoryID = 19 AND 1=1    
    ";
    ...
    if (isset($_POST["brand"])) {
        ...
        $query .= " AND brand.BrandName IN('" . $brand_filter . "') ";
    }
    ...
    if (isset($_POST["search"])) {
        ...
        $query .= " AND ProductDescription LIKE '%$search%' ";
    }
    ...
    <div class='nk-product' data-mouse-parallax-z='2'>
        ...
        <div class='nk-image-box-1-a'>
            ...
            if (!isset($_SESSION['userId'])) {
                $output .= "<a href='singlePrebuilt.php?product_id=$product_id' class='nk-image-box-icon-btn'><span class='p-15 ion-eye'></span></a>"
        ...
        <div class='card-body'>
            <h5 class='card-title'><a href='singlePrebuilt.php?product_id=$product_id'>$product_name</a></h5>
            <p class='card-text'>$product_description</p>
        </div>
        <div class='card-footer d-flex justify-content-between align-items-center'>
            <div >
             <h5 class='card-title'><a href='singlePrebuilt.php?product_id=$product_id'>Price: ₹$product_price/-</a></h5>
    ...
    <div class='modal-dialog modal-dialog-centered modal-lg' role='document'>
        <div class='modal-content'>
            ...
            <div class='Product-image'>
                <img src='../seller/product_images/$product_image1' alt='$product_name' >
                </div><p>$product_description</p> <!-- Use the correct product description variable -->
            </div>
